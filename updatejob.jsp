    ...
    <div class="container">
        ...
        <% 
            ...
            try {
                ...
                // Setting the deadline requires converting the string to a java.sql.Date object
                if (deadline != null && !deadline.isEmpty()) {
                    Date deadlineDate = Date.valueOf(deadline);
                    stmt.setDate(5, deadlineDate);
                } else {
                    stmt.setDate(5, null); // Set deadline to null if it's empty
                }
        ...
        %>
                    <script>
                        ...
                        window.location.href = "homejobporatl.html"; // Redirect to the view job portal page
                    </script>
        <% 
                } else {
        %>
